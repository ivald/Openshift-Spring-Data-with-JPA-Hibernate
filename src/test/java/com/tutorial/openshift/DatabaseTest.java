package com.tutorial.openshift;

import com.tutorial.openshift.service.Fruit;
import com.tutorial.openshift.service.FruitRepository;
...
public class DatabaseTest {
    ...
    public void createAndDeleteAFruit() {
        ...
        Fruit fruit = fruitRepository.findOne(orangeId);
        assertNull(fruit);
    }

    @Test
    public void getWrongId() {
        Fruit fruit = fruitRepository.findOne(9999L);
        assertNull(fruit);
    }
}
